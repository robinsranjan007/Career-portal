...
import { applyJob, deleteApplication, getJobApplication, getMyApplication, updateApplication } from "../controllers/applicationController.js"
...
router.delete('/:applicationId', authMiddleware, authorizeMiddleware('seeker'), deleteApplication)
